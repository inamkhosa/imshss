...
int  main (int argc, char *argv[])
{
	...
	/*if ( 2 !=argc)
	{
		...
		printf("\n Correct Usage:\n\t HSS PathOfHSSConfigFile.xml\n\n");
		return 0;
	}*/

	unsigned char ucConfigFile[1024] = {0};
	strcpy(ucConfigFile, DATADIR);
	strcat(ucConfigFile,"hss_config.xml");
	//printf(ucConfigFile);
	//printf("\r\n");
    ...
    if(NULL == AMPS_SchedInit(hFrameworkHandle,HSS_MAX_NUM_INTERNAL_EVENTS,HSS_MAX_NUM_EXTERNAL_EVENTS,NULL,NULL,NULL, NULL))
    {
	...
	printf("\n\n Terminating Home Subscriber Server \n\n ");
    return 0;
}
